...
#ifdef __RTX
           ((USBD_RTX_DevTask   != 0) ? USB_CNTR_ERRM    : 0) |
           ((USBD_RTX_DevTask   != 0) ? USB_CNTR_PMAOVRM : 0) |
           ((USBD_RTX_DevTask   != 0) ? USB_CNTR_SOFM    : 0) |
           ((USBD_RTX_DevTask   != 0) ? USB_CNTR_ESOFM   : 0);
#else
           ((USBD_P_Error_Event != 0) ? USB_CNTR_ERRM    : 0) |
           ((USBD_P_Error_Event != 0) ? USB_CNTR_PMAOVRM : 0) |
           ((USBD_P_SOF_Event   != 0) ? USB_CNTR_SOFM    : 0) |
           ((USBD_P_SOF_Event   != 0) ? USB_CNTR_ESOFM   : 0);
#endif
...
void USBD_Suspend(void)
{
    ...
    USB->CNTR |= USB_CNTR_LPMODE;                  /* Low Power Mode                     */
}
